(function(global) {
  ...
  var wordsList =  [
      ...
      },
      {
          ...
          "name": "梁会锋",
          "words": "感觉现在是一个全民学编程的时代，不想被时代抛弃。JS在新大是最便宜的一门编程课，但便宜并不意味着教学质量差。所以JS就成了我踏入猿类的第一步，希望自己能从人倒（jin）退（hua）到猿……"
      },
      {
      ...
      {
          "avatar": "http://wx3.sinaimg.cn/large/61cb7abdgy1fi85e6hp1tj20gx0gxgor.jpg",
          "name": "杨铁明",
          "words": "我想学习一门面向未来的赖以生存的技术"
      },
      {
          "avatar": "你头像的链接地址",
          "name": "你的名字",
      ...
      },
      {
          ...
          "name": "��ѧ��",
          "words": "�ӿ�ʼѧϰ��̵�ʹ��ASP.NET��д��һ������ϵͳ��վ��ǰ����ʱһ��࣬����������У�һ·�Ŀİ��������Ϊ���µĽ��桢���ѺõĽ�����ʽ���������û�ʹ�ö����ָ���Ķ�����Bootstrap��JavaScript��jQuery......��վҲ�ӿ�ʼ����һ����ASP.NET�����ŵ���ͨ�������ӣ��ڲ���԰�ҿؼ����÷��������ڻ�дһ��򵥵� JavaScript �����Ӧ�û����������� Bootstrap ����վ���в��֡����֮����Ҫѧϰ JavaScript �γ̣�������Ŀ�ġ�һ����ͨ������ʦһ��ѧϰ���ܹ����õ����� JavaScript,������Ҳ����Ϊ�ڿγ�Ŀ¼�￴����ʦ�ὲ jQuery �����ñ���Ҫ������Ρ�������ʹ����һ��ѧϰ������ʦ���Σ���������һ�����������ղ�һ�����뷨��ѧ��������˼ά�����֪ʶ��"
      },
      {
          "avatar": "https://thumbnail0.baidupcs.com/thumbnail/4af2761c0fa234beefa30aeea1f1c678?fid=2167604973-250528-6593371609396&time=1502204400&rt=sh&sign=FDTAER-DCb740ccc5511e5e8fedcff06b081203-KQzyDwlzJP3%2BLIdIRhKd4QTCIfs%3D&expires=8h&chkv=0&chkbd=0&chkpc=&dp-logid=5101655095140748356&dp-callid=0&size=c710_u400&quality=100&vuk=-&ft=video",
          "name": "尤石磊",
